...
class DaoManager: NSObject {
    ...
    override init() {
        ...
        categoryDao = CategoryDao(managedObjectContext)
        selectionDao = SelectionDao(managedObjectContext)
        optionDao = OptionDao(managedObjectContext)
        roomDao = RoomDao(managedObjectContext)
        chatDao = ChatDao(managedObjectContext)
    }
